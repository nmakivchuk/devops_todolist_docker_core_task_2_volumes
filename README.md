...
TODOAPP IMAGE: https://hub.docker.com/repository/docker/nmakivchuk01/todoapp/general #2.0.0
MYSQL IMAGE: https://hub.docker.com/repository/docker/nmakivchuk01/mysql-local/general
